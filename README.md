...
- **Sixth Sense 2 WF6·7 DI5** - 100% PVC Free PU 소재. 균일 5ips 풀싱킹. 6% 저신장으로 훅셋 에너지 손실 최소화. Titan 3D 대비 균일침하 비교 검증용 서브 라인 ⭐⭐⭐⭐⭐
...
### T&T Helix 863-4 (2026.04) 🆕
처음으로 작정하고 고른 드라이플라이 전용 로드. T&T 미디엄 계열 빈티지 클래식으로, Paradigm과 같은 DNA를 가지면서 더 가볍고 더 섬세한 #3 피네스 피싱의 세계를 열어준다. 관리형 낚시터 표층권 피네스 피싱(& 마이크로님핑)의 최적의 태클.

**셋업 구성:**
- 🎣 **로드**: T&T Helix 863-4 (#3 / 8'6" / Medium Action / Graphite)
- 🧵 **라인**: RIO Elite Technical Trout WF4F (오버라이닝 세팅)
- 📏 **티펫**: 6x~7x Fluorocarbon 2~3m
- 🪝 **플라이**: Chironomid Larva/Pupa #16~20 · Dry Fly

**Helix 시리즈 연대기:**
- 📍 T&T 전성기(2000년대 초반) 연간 12,000개 생산 시대의 주요 시리즈
- 🏆 Paradigm(클래식)과 함께 T&T 라인업의 양대 미디엄 계열
- 📉 2005년 UK 투자자 인수 후 경영 혼란기에 단종
- 💎 현재: 15~20년 전 생산 빈티지 · T&T 특유의 '쫀득한 액션'은 현재도 유효

---

### Airflo Euro Nymph Short 22ft (2026.03) 🆕
예민한 송어를 꼬셔낼 방법으로, 루어낚시의 '네오스타일'에서 모티브를 얻은 채비. 표층·중층·바닥까지 전층을 공략 대상으로 하며, 바닥층을 집중적으로 노리는 구성. 작고 가벼운 훅을 천천히 오래 떨어뜨리면서(텐션폴) 리더라인만으로 입질을 감지하고, 바닥에 착지 후 지긋이 천천히 끌어올리는 로드워크 액션만으로 송어를 낚아내는 드리프트 낚시. 여기에 유로님핑 채비를 접목시킴으로써 완성도를 높여가는 피싱.

**셋업 구성:**
- 🎣 **로드**: Vision Onki 3100-4 (10ft / #3 / 미디엄패스트)
- 🪝 **백킹라인**: RIO Technical Euro Nymph (불용 재활용)
- 🔗 **쇼티 연결**: 루프투루프
- 📏 **롱리더**: 투톤 인디케이터 2X (1.5m) + 레벨리더 3X→4X→5X (각 2.0m) + 스위벨 도래 + 티펫 6X

---

### Airflo Sixth Sense 2 WF6·7 DI5 (2026.03)
도착 당일 첫 스트레칭에서 "엇?!!" — PVC 라인에 익숙한 탓인지 처음 당겼을 때 안 늘어나는 느낌이 강렬했습니다. 6% 저신장 PU 소재의 쫀쫀하고 딴딴한 물성. 초기 코일링은 미지근한 온수 + 여러 번 스트레칭으로 해결. 풀싱킹 인벤토리 SUB A로 포지셔닝, Titan 3D i/3/5 대비 전 구간 균일 5ips 직선 침하의 차이가 조과로 이어지는지 비교 검증 예정.

**주요 스펙:**
- 🔵 **Sink 5 (5.0ips)** — 전 구간 균일 침하
- 📏 **Head 46ft** — Front Taper 20' + Belly 16' + Rear Taper 10'
- 💪 **Low Stretch 6%** — 경쟁사 PVC 대비 1/4 수준
- 🌿 **100% PVC Free** — Polyurethane, 1984년부터
- 📍 **Hang Markers** — 10ft / 20ft / 40ft 3개 내장

---

### Sink 25 Cold Manual v2 (2026.03)
한터낚시터 3/14 세션 51마리 데이터를 바탕으로 Sonar Sink 25 Cold의 포지션을 전면 재정의. "버티컬 지깅 독립 운용"(v1)에서 **바닥권 풀싱킹 체계의 서브 라인**으로 진화.
